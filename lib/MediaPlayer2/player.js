...
class Player extends proxyabstraction_1.default {
    constructor(proxyObject) {
        ...
        props.on("PropertiesChanged", (iface, changed, invalidated) => {
            ...
            for (let key in changed) {
                ...
                this[key] = utils_1.marshallVariants(changed[key]);
            }
    ...
    _init() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            this.Position = utils_1.marshallVariants(yield props_1.getProperty(this._proxyObject, this._interfaceName, "Position"));
