...
class Player extends proxyabstraction_1.default {
    ...
    GetPosition() {
        return __awaiter(this, void 0, void 0, function* () {
            return (0, utils_1.marshallVariants)(yield (0, props_1.getProperty)(this._proxyObject, this._interfaceName, "Position"));
        });
    }
    OpenUri(uri) {
        return __awaiter(this, void 0, void 0, function* () {
    ...
    set LoopStatus(value) {
        ...
        (0, props_1.setProperty)(this._proxyObject, this._interfaceName, "LoopStatus", "s", value);
    }
    get Rate() {
        return this._Rate;
    }
    set Rate(value) {
        this._Rate = value;
        (0, props_1.setProperty)(this._proxyObject, this._interfaceName, "Rate", "d", value);
    }
    get Shuffle() {
    ...
    set Shuffle(value) {
        this._Shuffle = value;
        (0, props_1.setProperty)(this._proxyObject, this._interfaceName, "Shuffle", "b", value);
    }
    get Volume() {
        return this._Volume;
    }
    set Volume(value) {
        this._Volume = value;
        (0, props_1.setProperty)(this._proxyObject, this._interfaceName, "Volume", "d", value);
    }
}
